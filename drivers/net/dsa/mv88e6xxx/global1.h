...
#define MV88E6XXX_G1_STATS_OP_MASK		0x7000
...
#define MV88E6XXX_G1_STATS_OP_HIST_MODE_MASK	0x0c00
...
int mv88e6xxx_g1_ip_pri_map(struct mv88e6xxx_chip *chip);
int mv88e6xxx_g1_ieee_pri_map(struct mv88e6xxx_chip *chip);
