...
static struct mv88e6xxx_pri_setup(struct mv88e6xxx_chip *chip)
{
	int err;
...
static int mv88e6xxx_devmap_setup(struct mv88e6xxx_chip *chip)
{
	...
	for (target = 0; target < 32; ++target) {
		port = 0x1f; /* safe since bit 4 is reserved on older chips */
...
static const struct mv88e6xxx_ops mv88e6085_ops = {
	...
	.ieee_pri_map = mv88e6xxx_g1_ieee_pri_map,
	.ip_pri_map = mv88e6xxx_g1_ip_pri_map,
